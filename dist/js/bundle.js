...
console.log('Using imported functions: ' + searchView.add(searchView.ID, 2) + ' and ' + searchView.multiply(3, 5) + '. ' + _Search2.default);
...
exports.default = 'I am an export string';
